...
describe("UCSBOrganizationForm tests (no id)", () => {
  const queryClient = new QueryClient();
  ...
  test("renders correctly with no initialContents", async () => {
    ...
    // ✅ only checks for relevant fields
    expect(screen.getByTestId(`${testId}-submit`)).toBeInTheDocument();
    expect(screen.getByTestId(`${testId}-inactive`)).toBeInTheDocument();
    expect(screen.getByTestId(`${testId}-orgTranslation`)).toBeInTheDocument();
  ...
  test("renders correctly when passing in initialContents", async () => {
    ...
    // ✅ removed id-related checks
    expect(screen.getByDisplayValue("UCSB")).toBeInTheDocument();
    expect(screen.getByDisplayValue("UCSBBAD")).toBeInTheDocument();
