...
public class UCSBOrganizationWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_organization() throws Exception {
    ...
    page.getByTestId("UCSBOrganizationForm-orgCode").fill("UCSB");
    page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("UCSBBAD");
    page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("UCSBBAD");
    ...
    page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("UCCC");
    page.getByTestId("UCSBOrganizationForm-inactive").selectOption("false");
    page.getByTestId("UCSBOrganizationForm-submit").click();

    // page.waitForSelector("[data-testid='UCSBOrganizationTable-cell-row-0-col-orgTranslationShort']");
